...
namespace oranj::eval::nnue::features::psq {
    ...
    struct PsqFeaturesBase {
        ...
        struct Updates {
            ...
            inline void addThreatFeature(Piece attacker, Square attackerSq, Piece attacked, Square attackedSq) {
                OJ_UNUSED(attacker, attackerSq, attacked, attackedSq);
            }
            ...
            inline void setPawnBbs(
                ...
                OJ_UNUSED(blackBefore, whiteBefore, blackAfter, whiteAfter);
            }
        };
    };
