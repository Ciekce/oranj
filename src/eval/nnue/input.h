...
namespace oranj::eval::nnue {
    ...
    private:
        OJ_SIMD_ALIGNAS util::MultiArray<Type, 2, kOutputCount> m_outputs;
    ...
    struct FeatureTransformer {
        ...
        OJ_NETWORK_PARAMS(PsqWeightType, kPsqWeightCount, psqWeights);
        OJ_NETWORK_PARAMS(ThreatWeightType, kThreatWeightCount, threatWeights);
        OJ_NETWORK_PARAMS(OutputType, kBiasCount, biases);
