...
namespace oranj::eval::nnue::arch {
    ...
    private:
        ...
        OJ_SIMD_ALIGNAS std::array<i8, kOutputBucketCount * kL1Size * kL2Size> l1Weights{};
        OJ_SIMD_ALIGNAS std::array<i32, kOutputBucketCount * kL2Size> l1Biases{};

        OJ_SIMD_ALIGNAS std::array<i32, kOutputBucketCount * kL2SizeFull * kL3Size> l2Weights{};
        OJ_SIMD_ALIGNAS std::array<i32, kOutputBucketCount * kL3Size> l2Biases{};

        OJ_SIMD_ALIGNAS std::array<i32, kOutputBucketCount * kL3Size> l3Weights{};
        OJ_SIMD_ALIGNAS std::array<i32, kOutputBucketCount> l3Biases{};
        ...
        inline void propagateL1(
            ...
            OJ_SIMD_ALIGNAS util::MultiArray<Vector<i32>, kL2Size / kChunkSize<i32>, 4> intermediate{};
