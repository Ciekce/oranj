...
namespace oranj::eval::nnue::arch {
    ...
    struct PairwiseMultilayerCReLUSCReLUCReLU {
        ...
        using L1WeightType = i8;
        using L1BiasType = i32;
        using L2WeightType = i32;
        using L2BiasType = i32;
        using L3WeightType = i32;
        using L3BiasType = i32;
    ...
    private:
        ...
        OJ_NETWORK_PARAMS(i8, kL1WeightCount, l1Weights);
        OJ_NETWORK_PARAMS(i32, kL1BiasCount, l1Biases);

        OJ_NETWORK_PARAMS(i32, kL2WeightCount, l2Weights);
        OJ_NETWORK_PARAMS(i32, kL2BiasCount, l2Biases);

        OJ_NETWORK_PARAMS(i32, kL3WeightCount, l3Weights);
        OJ_NETWORK_PARAMS(i32, kL3BiasCount, l3Biases);
