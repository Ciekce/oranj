...
namespace oranj::eval::nnue::arch {
    ...
    struct SingleLayer {
        ...
        using L1WeightType = i16;
        using L1BiasType = i16;
        using L2WeightType = std::byte;
        using L2BiasType = std::byte;
        using L3WeightType = std::byte;
        using L3BiasType = std::byte;
    ...
    private:
        ...
        OJ_NETWORK_PARAMS(i16, kWeightCount, l1Weights);
        OJ_NETWORK_PARAMS(i16, kBiasCount, l1Biases);
    ...
    public:
        ...
        static inline void permuteFt(
            ...
            OJ_UNUSED(psqWeights, threatWeights, biases);
        }
    };
} // namespace oranj::eval::nnue::arch
