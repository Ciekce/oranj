...
namespace oranj::eval {
    namespace {
        ...
        OJ_ALWAYS_INLINE_NDEBUG inline void applyThreatRows(
...
#if OJ_HAS_VBMI2
        OJ_ALWAYS_INLINE_NDEBUG inline __m512i ppIdxEpi16(__m512i a, __m512i b) {
        ...
        OJ_ALWAYS_INLINE_NDEBUG inline __m256i ppIdxEpi16(__m256i a, __m256i b) {
        ...
        OJ_ALWAYS_INLINE_NDEBUG inline void generatePpRows(
            Color c,
            Square kingSq,
