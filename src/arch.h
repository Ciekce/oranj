...
#include <new>
    ...
    // cannot expand a macro to defined()
        ...
        #define OJ_HAS_VBMI2 __AVX512VBMI2__
        #define OJ_HAS_VBMI __AVX512VBMI__
        #define OJ_HAS_AVX512 (__AVX512F__ && (__AVX512BW__ || __AVX512VNNI__))
    #else
        #define OJ_HAS_VNNI512 0
        #define OJ_HAS_VBMI2 0
        #define OJ_HAS_VBMI 0
    ...
    #define OJ_HAS_NEON __ARM_NEON
        ...
        #define OJ_HAS_NEON_DOTPROD __ARM_FEATURE_DOTPROD
    #else
    ...
    #define OJ_HAS_VBMI2 1
    #define OJ_HAS_VBMI 1
    ...
    #define OJ_HAS_NEON 1
    #define OJ_HAS_NEON_DOTPROD 1
#else
