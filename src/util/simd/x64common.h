...
#if OJ_HAS_AVX512 || OJ_HAS_AVX2 || OJ_HAS_SSE41

#include <immintrin.h>

namespace oranj::util::simd::impl::x64
{
#if OJ_HAS_SSE41
	OJ_ALWAYS_INLINE_NDEBUG inline auto hsumI32Sse41(__m128i v) -> i32
	{
...
#if OJ_HAS_AVX2
	OJ_ALWAYS_INLINE_NDEBUG inline auto hsumI32Avx2(__m256i v) -> i32
	{
...
#if OJ_HAS_AVX512
	OJ_ALWAYS_INLINE_NDEBUG inline auto hsumI32Avx512(__m512i v) -> i32
	{
